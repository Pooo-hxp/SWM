...
function convert() {
	if(document.FORM.atc_content.value != '') {
		if(document.getElementById("jianfan").value == 0)
			document.FORM.atc_content.value = simplized2(document.FORM.atc_content.value);
		else
			document.FORM.atc_content.value = traditionalized2(document.FORM.atc_content.value);
	} else alert('没有可转换的内容！');
}
